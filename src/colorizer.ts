...
const AUTHOR_LINE = chalk.yellow('colorgs ') + chalk.cyan('v'+process.env.npm_package_version) + chalk.yellow(' by ') + chalk.white('Joël TROUSSET ') + chalk.green('- https://github.com/troussej/atg-log-colorizer');
